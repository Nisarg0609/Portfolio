  ...
  return (
    <>
      ...
      <div className="h-auto py-10 flex items-center justify-center px-[5%] md:px-0">
        <div className="" style={{ width: "70dvw" }}>
          <div
            data-aos="fade-right"
          ...
          >
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  ...
                  <a href="mailto:patelnisarg3375@gmail.com" style={{ color: "blue" }}>
                    patelnisarg3375@gmail.com
                  </a>{" "}
            ...
            <div style={{ display: "flex", gap: "2rem" }}>
              <div style={{ flex: 1 }}>
                <form
                  action="https://formsubmit.co/patelnisarg3375@gmail.com"
                  method="POST"
