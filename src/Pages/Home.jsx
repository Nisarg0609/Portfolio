...
const WORDS = ["React Developer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "MongoDB"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/nisarg0609" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/nisargp09/" },
  { icon: Instagram, link: "https://www.instagram.com/_nisarg__patel_/" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  A dedicated Full-Stack developer passionate about building seamless and
                ...
                <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
                  <a
                    href="https://drive.google.com/file/d/1DjvAAMRack7VNnHVI0-AIWovhxRLJOaY/view?usp=drive_link"
